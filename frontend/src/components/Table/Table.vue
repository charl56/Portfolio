  ...
  <div class="div-table">
    ...
    <div class="space-40vh d-flex">
      ...
      <div class="d-flex align-center div-post-header">
        <v-img v-if="langue == 'Fr'" class="icon-post-header flag" :src="iconFR" :width="imageSize()" :height="imageSize()" @click="toggleLanguage()"></v-img>
        <v-img v-else class="icon-post-header flag" :src="iconENG" :width="imageSize()" :height="imageSize()" @click="toggleLanguage()"></v-img>
      </div>
    </div>

...
.title-image{
    ...
    flex-shrink:0;
    color: var(--background-color-1); /* Couleur du texte en blanc */
    text-shadow: -2px -2px 0 var(--font-color), 2px -2px 0 var(--font-color), -2px 2px 0 var(--font-color), 2px 2px 0 var(--font-color); /* Ombre de texte pour le contour noir */
    bottom: 20px;
